...
void ScanToPointCloud::scanCb(const sensor_msgs::LaserScan::ConstPtr& scan)
{
    ...
    // Find that the tf you need to relate the frame of the sensor to the odom frame exists
    ...
    { 
        ...
        projector_.transformLaserScanToPointCloud("/odom", *scan, cloud, tf_listener_);
