...
class LeicaMovUtils:
    ...
    def get_init_pose():
        ...
        try:
            ...
            resp = get_state("mobileman", "world")
            return resp
    ...
    def main(self):
        ...
        rospy.init_node('move_photoneo_pan')
        rospy.Subscriber("photoneo/simulator/window", RegionOfInterest, self.leica_window_callback)
        rospy.Subscriber("photoneo/simulator/resolution", Int64, self.leica_resolution_callback)

        # prepares the point cloud saving service
        rospy.wait_for_service('/photoneo/store_cloud')
        srv_save_cloud = rospy.ServiceProxy('/photoneo/store_cloud', Trigger)
        ...
        state_msg.model_name = 'mobileman'
        ...
        while not rospy.is_shutdown():
            ...
            if self.move_permit == True:
                ...
                rospy.loginfo("move_photoneo_pan: movement finished")
