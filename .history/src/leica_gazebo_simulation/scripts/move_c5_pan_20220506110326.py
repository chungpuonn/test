...
class LeicaMovUtils:
    ...
    def leica_window_callback(self, msg):
        ...
        roll_increment = abs(self.ini_scan_ori - self.end_scan_ori)/self.horizontal_res

        # array of <horizontal_res> elements populated with <roll_increment> with <ini_scan_ori> as first element
        self.x_orientations = [float(roll_increment)] * self.horizontal_res
        self.x_orientations[0] = float(self.ini_scan_ori)
