...
MODEL_NAME = "mobileman"


def get_model_tf_cb(msg):
    """Read mobileman model state and publish to tf tree as transform between /world --> /photoneo_link 
    ...
    b.sendTransform(translation, rotation, Time.now(), '/photoneo_link', '/world')
